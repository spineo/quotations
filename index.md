...
The [_load_quotes_sqlite.pl_](https://github.com/spineo/perl-scripts/blob/master/bin/quotes/load_quotes.sqlite.pl) scripts takes as input the JSON formatted data structure generated by the _filter_quotes.pl_ script and loads the data into the database tables.
